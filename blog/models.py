...
class cate(models.Model):
    cate_name = models.CharField(blank=False, max_length=30, verbose_name="文章类别")  # False表示此项不能为空
...
class blog(models.Model):
    ...
    blog_seenum = models.IntegerField(verbose_name="浏览次数", blank=True)  # True表示可不填
